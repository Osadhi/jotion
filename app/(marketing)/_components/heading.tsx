...
export const Heading = () => {
    ...
    return (
        <div className="max-w-3xl space-y-4">
            <h1 className="text-3xl sm:text-5xl md:text-6xl font-bold">Your Ideas, Documents, & palns, Unified, welcome
                to <span className="underline">Jotion</span></h1>
            ...
            {isAuthenticated && !isLoading && (
                <Button asChild>
                    <Link href="/documents">Enter Jotion <ArrowRight className="h-4 w-4 ml-2"/></Link>
                </Button>
            )
            }
        </div>
